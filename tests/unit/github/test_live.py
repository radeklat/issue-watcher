...
class TestChecksLive:
    @staticmethod
    def test_open_issue_check_fails_when_closed(assert_github_issue_no_cache: AssertGitHubIssue,):
    ...
    @staticmethod
    def test_open_issue_check_does_not_fail_when_open(assert_github_issue_no_cache: AssertGitHubIssue,):
        assert_github_issue_no_cache.is_open(OPEN_ISSUE_NUMBER)

    @staticmethod
    def test_closed_issue_check_fails_when_open(assert_github_issue_no_cache: AssertGitHubIssue,):
        with pytest.raises(AssertionError):
            assert_github_issue_no_cache.is_closed(OPEN_ISSUE_NUMBER)

    @staticmethod
    def test_closed_issue_check_does_not_fail_when_closed(assert_github_issue_no_cache: AssertGitHubIssue,):
        assert_github_issue_no_cache.is_closed(CLOSED_ISSUE_NUMBER)

    @staticmethod
    def test_release_number_check_fails_when_new_releases_available(assert_github_issue_no_cache: AssertGitHubIssue,):
    ...
    @staticmethod
    def test_version_check_fails_when_available(assert_github_issue_no_cache: AssertGitHubIssue,):
